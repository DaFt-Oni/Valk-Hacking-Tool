...
def emular_tag():
    print(f"\n{Colors.OKGREEN}[+] Modo de emulación de tag NFC activado.{Colors.ENDC}")
    print("Simulando un tag NFC con el mensaje: 'Hola, soy un tag emulado!'")
    record = TextRecord("Hola, soy un tag emulado!")
